        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            <h1 className="text-4xl md:text-5xl font-bold">
              Gerçek <span className="bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent">TikTok</span> Beğenileri
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="text-3xl font-bold flex items-center justify-center gap-2">
              ...
              TikTok <span className="text-[#4070F4]">Beğeniler</span>
            </h1>
            <p className="mt-4 text-gray-600">
              Gerçek ve aktif izleyicilerle TikTok beğenilerinizi artırın. Mükemmel görünürlük paketinizi seçin.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mt-8">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 relative hover:shadow-md transition-shadow">
              <div className="flex items-center gap-2 text-green-600 mb-4">
                ...
                <span>100 Beğeniler</span>
              </div>
              <div className="text-center mb-4">
                <h3 className="text-xl font-bold">100 Likes</h3>
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-center text-sm text-gray-600">
                  ...
                  Aktif kullanıcılardan gerçek beğeniler
                </li>
                <li className="flex items-center text-sm text-gray-600">
                  <svg className="w-4 h-4 mr-2 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 relative border-2 border-[#4070F4] hover:shadow-lg transition-shadow">
              ...
              <div className="flex items-center gap-2 text-[#FF9119] mb-4">
                ...
                <span>1000 Beğeniler</span>
              </div>
              <div className="text-center mb-4">
                <h3 className="text-xl font-bold">1000 Likes</h3>
                <div className="flex items-center justify-center gap-1 mt-2">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 relative hover:shadow-md transition-shadow">
              <div className="flex items-center gap-2 text-green-600 mb-4">
                ...
                <span>5000 Beğeniler</span>
              </div>
              <div className="text-center mb-4">
                <h3 className="text-xl font-bold">5000 Likes</h3>
                <div className="flex items-center justify-center gap-1 mt-2">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 relative hover:shadow-md transition-shadow">
              <div className="flex items-center gap-2 text-green-600 mb-4">
                ...
                <span>10000 Beğeniler</span>
              </div>
              <div className="text-center mb-4">
                <h3 className="text-xl font-bold">10000 Likes</h3>
                <div className="flex items-center justify-center gap-1 mt-2">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 relative hover:shadow-md transition-shadow">
              <div className="flex items-center gap-2 text-green-600 mb-4">
                ...
                <span>25000 Beğeniler</span>
              </div>
              <div className="text-center mb-4">
                <h3 className="text-xl font-bold">25000 Likes</h3>
                <div className="flex items-center justify-center gap-1 mt-2">
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 relative hover:shadow-md transition-shadow">
              <div className="flex items-center gap-2 text-green-600 mb-4">
                ...
                <span>50000 Beğeniler</span>
              </div>
              <div className="text-center mb-4">
                <h3 className="text-xl font-bold">50000 Likes</h3>
                <div className="flex items-center justify-center gap-1 mt-2">
