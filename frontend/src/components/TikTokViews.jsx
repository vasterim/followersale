        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            <h1 className="text-4xl md:text-5xl font-bold">
              Gerçek <span className="bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent">TikTok</span> Görüntülenmeleri
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="text-3xl font-bold flex items-center justify-center gap-2">
              ...
              TikTok <span className="text-[#4070F4]">Görüntülenmeler</span>
            </h1>
            <p className="mt-4 text-gray-600">
              Gerçek ve aktif izleyicilerle TikTok görüntülenmelerinizi artırın. Mükemmel görünürlük paketinizi seçin.
            </p>
          </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 relative hover:shadow-md transition-shadow">
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-center text-sm text-gray-600">
                  ...
                  Aktif kullanıcılardan gerçek görüntülenmeler
                </li>
                <li className="flex items-center text-sm text-gray-600">
                  <svg className="w-4 h-4 mr-2 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
              ...
              <button className="w-full bg-[#4070F4] text-white py-2 rounded-lg hover:bg-[#3059C0] transition-colors flex items-center justify-center gap-2">
                <span>Başlayın</span>
